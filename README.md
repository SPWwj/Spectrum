...
* remember to clear cache and cookies before testing
* to run project on localhost, download the repo and run on localhost with latest dotnet SDK, appsettings.json required. IP address required(SQL Server Whitelist protected)
